        ...
        child: Column(
          children: <Widget>[
            ListTile(
              ...
              subtitle: Text(
                "Um temperaturunabhängig messen zu können, wird die Temperatur beim Messen und die Temperatur auf die die Bierspindel geeicht ist benötigt",
                overflow: TextOverflow.ellipsis,
                maxLines: 6,
              ),
            ),
                  ...
                  children: <Widget>[
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintText: "${widget._name} eingeben",
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          labelText: "Messtemperatur in °C",
                          hintText: "Messtemperatur eingeben",
                          alignLabelWithHint: true),
                      keyboardType: TextInputType.numberWithOptions(
                        decimal: true,
                      ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          labelText: "Spindel geeicht auf (°C)",
                          hintText:
                              "Temperatur auf die die Bierspindel geeicht ist eingeben",
                          alignLabelWithHint: true),
                      keyboardType: TextInputType.numberWithOptions(
                        decimal: true,
                      ),
            ...
            Text(
              "Korrigierter Wert: ${_correctedPlato?.toStringAsFixed(2) ?? "---"}",
              style: TextStyle(
                fontSize: 16,
